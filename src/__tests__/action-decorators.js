...
defineTest(__dirname, 'action-decorators', null, 'action-decorators/app/pods/foo/bar/route');
defineTest(__dirname, 'action-decorators', null, 'action-decorators/app/pods/foo/bar/controller');
